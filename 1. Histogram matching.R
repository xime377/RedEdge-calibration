#Set WD
#setwd("E:/Ximena/MSc Thesis/Results/UAV imagery/")
...
for (i in 1:length(T.img1))   
{
  ...
  writeRaster(T.img1[[i]],paste0("./Lonnstorp/2017_04_08/Micasense/Flight_2/H/",
                                substr(names(T.img1[i]),47,56),".tif"),datatype="FLT4S")
}
...
{
  T.img2[[i]] <- histMatch(T.img2[[i]],T.img2[[32]])   #histogram matching imgage 32
  writeRaster(T.img2[[i]],paste0("./Lonnstorp/2027_04_08/Micasense/Flight_2/H/",
                                 substr(names(T.img2[i]),47,56),".tif"),datatype="FLT4S")
}
